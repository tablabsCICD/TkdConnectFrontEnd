...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "Change_number": MessageLookupByLibrary.simpleMessage("నంబర్ మార్చు"),
    "EnterOTP": MessageLookupByLibrary.simpleMessage("OTPని నమోదు చేయండి"),
    ...
    "OTP_sent_to": MessageLookupByLibrary.simpleMessage("OTP వీరికి పంపబడింది"),
    "Re_post": MessageLookupByLibrary.simpleMessage("మళ్లీ పోస్ట్ చేయండి"),
    "RegisterHere": MessageLookupByLibrary.simpleMessage(
    ...
    "addImagesAt": MessageLookupByLibrary.simpleMessage(
      "కేవలం ₹0 వద్ద చిత్రాలను జోడించండి",
    ),
    "addNews": MessageLookupByLibrary.simpleMessage("వార్త జోడించండి"),
    "addReport": MessageLookupByLibrary.simpleMessage("ఘటన నివేదిక జోడించండి"),
    "addRoutes": MessageLookupByLibrary.simpleMessage(
      "మెరుగైన లీడ్ జనరేషన్ కోసం మార్గాలను జోడించండి",
    ),
    "agentBroker": MessageLookupByLibrary.simpleMessage("ఏజెంట్/బ్రోకర్"),
    "allIncident": MessageLookupByLibrary.simpleMessage("అన్ని సంఘటనలు"),
    "allNews": MessageLookupByLibrary.simpleMessage("అన్ని వార్తలు"),
    "allRoutes": MessageLookupByLibrary.simpleMessage("బధా మార్గో"),
    "allUsers": MessageLookupByLibrary.simpleMessage("బధా వర్తకకర్తలు"),
    "already_have_account": MessageLookupByLibrary.simpleMessage(
      "ఇప్పటికే ఖాతా ఉందా?",
    ),
    "appCrash": MessageLookupByLibrary.simpleMessage("ఎప్ క్రేష్"),
    "appSetting": MessageLookupByLibrary.simpleMessage("యాప్ సెట్టింగ్"),
    "bulkUpload": MessageLookupByLibrary.simpleMessage("బల్క్ లోడ్ అప్లోడ్"),
    "buy": MessageLookupByLibrary.simpleMessage("కొను"),
    "buySell": MessageLookupByLibrary.simpleMessage("వాహనం అమ్మకం/కొనుగోలు"),
    "buySellVehicle": MessageLookupByLibrary.simpleMessage(
      "వాహనం కొనండి/అమ్మండి",
    ),
    "buysellIssue": MessageLookupByLibrary.simpleMessage(
      "సమస్యను కొనండి/అమ్మండి",
    ),
    ...
    "checkRTODocs": MessageLookupByLibrary.simpleMessage(
      "ఆర్‌టిఓ పత్రాలు తనిఖీ చేయండి",
    ),
    "cityInterchange": MessageLookupByLibrary.simpleMessage("సిటీ ఇంటర్‌చేంజ్"),
    ...
    "complete": MessageLookupByLibrary.simpleMessage("పూర్తి చేయి"),
    "completeMsg": MessageLookupByLibrary.simpleMessage(
      "మీరు ఈ పోస్ట్‌ను పూర్తి చేయాలనుకుంటున్నారా?",
    ),
    "completed": MessageLookupByLibrary.simpleMessage("పూర్తయింది"),
    "createJobPost": MessageLookupByLibrary.simpleMessage(
      "ఉద్యోగ పోస్ట్ సృష్టించు",
    ),
    "createPost": MessageLookupByLibrary.simpleMessage("పోస్ట్‌ని సృష్టించు"),
    "createPostLoadIssue": MessageLookupByLibrary.simpleMessage(
      "పోస్ట్ ఇష్యూ లోడ్ చేయి",
    ),
    "creategroup": MessageLookupByLibrary.simpleMessage(
    ...
    "editProfile": MessageLookupByLibrary.simpleMessage("ప్రోఫైల్ సంపాదిత కరో"),
    "editYourProfile": MessageLookupByLibrary.simpleMessage(
      "మీ ప్రొఫైల్‌ని సవరించండి",
    ),
    ...
    "egManageInquiries": MessageLookupByLibrary.simpleMessage(
      "ఉదా. విచారణలను నిర్వహించండి",
    ),
    "egMobile": MessageLookupByLibrary.simpleMessage("ఉదా మొబైల్"),
    "egPune": MessageLookupByLibrary.simpleMessage("ఉదా.పూణె"),
    "egSal": MessageLookupByLibrary.simpleMessage("ఉదా. 1LPA -2 LPA"),
    "egSeniorManager": MessageLookupByLibrary.simpleMessage(
      "ఉదా. సీనియర్ ట్రాఫిక్ మేనేజర్",
    ),
    "egSubTitle": MessageLookupByLibrary.simpleMessage("ఉదా. ఉప శీర్షిక"),
    "egTitleofPost": MessageLookupByLibrary.simpleMessage(
      "ఉదా. పోస్ట్ యొక్క శీర్షిక",
    ),
    ...
    "expiryDate": MessageLookupByLibrary.simpleMessage("గడువు తేది"),
    "financeInquiry": MessageLookupByLibrary.simpleMessage("ఆర్థిక విచారణ"),
    ...
    "iHaveVehicle": MessageLookupByLibrary.simpleMessage("నా దగ్గర వాహనం ఉంది"),
    "iWantVehicle": MessageLookupByLibrary.simpleMessage("నాకు వాహనం కావాలి"),
    "insurance": MessageLookupByLibrary.simpleMessage("బీమా"),
    ...
    "introThreeDescription": MessageLookupByLibrary.simpleMessage(
      "మా విస్తృత నెట్‌వర్క్‌తో, విస్తృత స్థాయికి చేరుకోవడానికి మేము మీకు సహాయం చేస్తాము.",
    ),
    "introTwoDescription": MessageLookupByLibrary.simpleMessage(
      "మీ అవసరాలు మా నైపుణ్యాలు. మనం రెండింటినీ కలిపి, కలిసి పైకి లేద్దాం",
    ),
    "jobDes": MessageLookupByLibrary.simpleMessage("ఉద్యోగ వివరణ"),
    "jobTitle": MessageLookupByLibrary.simpleMessage("ఉద్యోగ శీర్షిక"),
    "jobs": MessageLookupByLibrary.simpleMessage("ఉద్యోగాలు"),
    "language": MessageLookupByLibrary.simpleMessage("భాష"),
    "like": MessageLookupByLibrary.simpleMessage("ఇష్టం"),
    "loadPost": MessageLookupByLibrary.simpleMessage("పోస్ట్ లోడ్ చేయి"),
    ...
    "mParivahan": MessageLookupByLibrary.simpleMessage("ఎం పరివాహన్"),
    ...
    "myIncident": MessageLookupByLibrary.simpleMessage("నా ఘటన"),
    "myNews": MessageLookupByLibrary.simpleMessage("నా వార్తలు"),
    "myPost": MessageLookupByLibrary.simpleMessage("నా పోస్ట్‌లు"),
    "myQuote": MessageLookupByLibrary.simpleMessage("నా కోట్"),
    "myQuotes": MessageLookupByLibrary.simpleMessage("నా కోట్‌లు"),
    "myRoutes": MessageLookupByLibrary.simpleMessage("మారా మార్గో"),
    "news": MessageLookupByLibrary.simpleMessage("వార్తలు"),
    "newsDetail": MessageLookupByLibrary.simpleMessage("వార్త వివరాలు"),
    ...
    "pleaseSelectTopic": MessageLookupByLibrary.simpleMessage(
      "కృపా కరీనే విషయ పదార్ధం",
    ),
    "position": MessageLookupByLibrary.simpleMessage("స్థానం"),
    "post": MessageLookupByLibrary.simpleMessage("పోస్ట్"),
    "postAJob": MessageLookupByLibrary.simpleMessage(
    ...
    "quotesYouReceived": MessageLookupByLibrary.simpleMessage("పోస్ట్ జాబ్"),
    ...
    "showAllQuotes": MessageLookupByLibrary.simpleMessage(
      "అన్ని కోట్‌లను చూపించు",
    ),
    "showPostto": MessageLookupByLibrary.simpleMessage("పోస్ట్ చూపించు"),
    "specialInstruction": MessageLookupByLibrary.simpleMessage("ప్రత్యేక సూచన"),
    ...
    "terms_condition": MessageLookupByLibrary.simpleMessage("నియమాలు & నిబంధన"),
    ...
    "tollCalculation": MessageLookupByLibrary.simpleMessage("టోల్ లెక్కింపు"),
    ...
    "verifiedUsers": MessageLookupByLibrary.simpleMessage("చకాసాయెల్ విస్తరణ"),
  };
}
