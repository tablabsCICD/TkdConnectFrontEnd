  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.select_lang:
        return buildRoute(const SelectLanguageScreen(), settings: settings);

      case AppRoutes.intro_one:
        return buildRoute(const IntroScreenOne(), settings: settings);

      case AppRoutes.intro_two:
        return buildRoute(const IntroScreenTwo(), settings: settings);

      case AppRoutes.intro_three:
        return buildRoute(const IntroScreenThree(), settings: settings);
      ...
      case AppRoutes.registration_personal_details:
        return buildRoute(const PersonalDetailsScreen(), settings: settings);

      case AppRoutes.registration_company_details:
        return buildRoute(const CompanyDetailsScreen(), settings: settings);
      ...
      case AppRoutes.editprofile:
        return buildRoute(const EditProfileBaseScreen(), settings: settings);

      case AppRoutes.home:
        return buildRoute(const BaseDashboard(), settings: settings);
      case AppRoutes.search:
        return buildRoute(const SearchEditScreen(), settings: settings);
      ...
      case AppRoutes.job:
        return buildRoute(const JobListScreen(), settings: settings);
      ...
      case AppRoutes.mypost:
        return buildRoute(const MyPostBase(), settings: settings);

      case AppRoutes.buysell:
        return buildRoute(const BuySellScreen(), settings: settings);
      case AppRoutes.createjob:
        return buildRoute(const CreateJobScreen(), settings: settings);
