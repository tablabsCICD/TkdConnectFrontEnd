...
class IntroScreenOne extends StatelessWidget{
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            SvgPicture.asset(Images.intro_progress_one,width: 40.w,height: 6.h,)   ,
        InkWell(onTap:(){
          Navigator.pushReplacementNamed(context, AppRoutes.intro_two);
  ...
  image(){
    return SizedBox(
      ...
      height: 335.h,
      child:
      SvgPicture.asset(Images.intro_one,width: 335.w,height: 335.h,)
      ,
    );
  }
