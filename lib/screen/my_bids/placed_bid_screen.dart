...
class _PlacedBidScrrenState extends State<PlacedBidScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<MyBidsProvider>(
      builder: (context, provider, child) {
        return widget.provider.isLoad && provider.listBids.isEmpty
            ? Container(
                child: Center(
                ...
                itemBuilder: (
                  ...
                  return Container(
                      ...
                      child: Padding(
                          ...
                          child: cardLoad(index, context,
                              provider.listBids[index], provider)));
                });
      },
    );
  }
  ...
  cardLoad(
      int index, BuildContext context, Bids bids, MyBidsProvider provider) {
    return Container(
        width: 335.w,
        ...
        child: Column(
            ...
            children: [
              ...
              BaseWidget().heading(bids.topicName!,
                  bids.postingTime!.split(" ").first, bids.content!),
              bids.isAccepted == 0
                  ? SizedBox.shrink()
                  : Column(
                      children: [
  ...
  Future<void> showAcceptQuoteDialog(
      BuildContext context, Bids bids, MyBidsProvider provider) async {
