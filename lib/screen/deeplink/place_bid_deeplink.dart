...
class PlaceDeepBidScreen extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _PlaceDeepBidScreen();
  }

}

class _PlaceDeepBidScreen extends State<PlaceDeepBidScreen> {
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(onTap:(){Navigator.pushReplacementNamed(context, AppRoutes.home);},child: SvgPicture.asset(Images.close_circle))
                  ],
                ),
              ),
